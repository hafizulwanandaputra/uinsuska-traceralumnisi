<?= $this->extend('auth-admin/templates/login'); ?>
<?= $this->section('content'); ?>
<main class="card form-signin w-100 m-auto" style="box-shadow: 0 0.5rem 1rem rgba(0, 0, 0, 0.25)!important;">
    <?= form_open('check-login-admin'); ?>
    <h1 class="h3 mb-3 fw-normal">
        Login Admin
    </h1>
    <div class="form-floating">
        <input type="text" class="form-control username <?= (validation_show_error('username')) ? 'is-invalid' : ''; ?>" id="floatingInput" name="username" placeholder="Username" value="">
